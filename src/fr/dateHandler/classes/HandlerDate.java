package fr.dateHandler.classes;
...
//				 Affichage du résultat final
			...
			//String.format(" (Sous-entendu : lundi est le premier jour de l'année.)\n\n");
			return result;
		} else {
	...
	private void debug(String monthName, int daysOfMonth, int reste) {
		String.format("   On a retiré " + monthName + " (" + daysOfMonth + " jours) => Il reste " + reste + " jours.");
	}
}