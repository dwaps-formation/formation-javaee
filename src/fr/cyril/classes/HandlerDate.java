...
public class HandlerDate {
	...
	public void displayDate() {
		...
		//System.out.print("Choisir un numéro de jour de l'année [1-365] : "); // supprimer du code pour pouvoir l'utilisé en jee
		
		//try {// supprimer du code pour pouvoir l'utilisé en jee
		//	nbOfDay = scanner.nextInt();// supprimer du code pour pouvoir l'utilisé en jee
...
//				 Affichage du résultat final
			...
			//	System.out.println(" (Sous-entendu : lundi est le premier jour de l'année.)\n\n"); // supprimer du code pour pouvoir l'utilisé en jee
				
			} else {
			//	System.out.println("La valeur saisie n'est pas correcte...\n"); // supprimer du code pour pouvoir l'utilisé en jee
			}
	//	} catch (InputMismatchException e) { // supprimer du code pour pouvoir l'utilisé en jee
